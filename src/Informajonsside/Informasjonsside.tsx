                ...
                <div className={cls.element('container')}>
                    ...
                    <div className={cls.element('innhold')}>
                        ...
                        <div className={cls.element('ingress')}>
                            <Normaltekst>
                                Vi innfører en digital avtale om arbeidstrening.
                                Her får du en rask introduksjon til hvordan den
                        ...
                        >
                            ...
                            godkjenner avtalen i samme løsning i sanntid, på
                            hver sin PC eller mobil. NAV skal alltid godkjenne
                            avtalen til slutt, og først da kan arbeidstreningen
                            starte.
                        </EkstbanderbartPanelRad>
                        ...
                        >
                            Når deltageren, arbeidsgiveren og NAV har blitt
                            enige om å starte opp en arbeidstrening, oppretter
                            NAV en digital avtale. Deltager og arbeidsgiver vil
                            få tilsendt en lenke fra NAV når denne er klar til
                            innlogging.
                        </EkstbanderbartPanelRad>
                        ...
                        <EkstbanderbartPanelRad
                            classname={cls.element('info')}
                            svgIkon={
                                <Altinn className={cls.element('SubIkon')} />
                            }
                            headerTekst={{
                        ...
                        >
                            Deltaker og arbeidsgiver logger seg inn i avtalen
                            via ID-porten. Tilgang for arbeidsgiver styres
                            gjennom Altinn. For at en arbeidsgiver kan
                            representere en bedrift må personen ha rollen{'  '}
                            <u>Helse-, sosial- og velferdstjenester</u> eller
                            gis tilgang til enkelttjenesten{' '}
                            ...
                            <AltinnVideoModal
                                ...
                                lukkModal={() => setVideoModalOpen(false)}
                            />
                        </EkstbanderbartPanelRad>
                        ...
                        >
                            Innholdet i avtalen kan endres gjennom hele perioden
                            for arbeidstrening. Hvis innholdet i avtalen blir
                            endret etter at arbeidstreningen har startet, må
                            alle parter godkjenne avtalen på nytt.
                        </EkstbanderbartPanelRad>
                        ...
                        >
                            ...
                            versjonen. Alle godkjente avtaler blir tilgjengelige
                            i en liste. På den måten kan alle tre parter se
