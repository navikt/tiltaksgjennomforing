...
const createLinks = () => {
    const links = [{rel: 'manifest', href: '%PUBLIC_URL%/manifest.json'},{rel: 'shortcut icon', href: '%PUBLIC_URL%/favicon.ico'}, {rel: 'stylesheet', href: '%PUBLIC_URL%/index.css'}]
