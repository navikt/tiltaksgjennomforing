    ...
    },
    {
        komponent: (
            <GodkjenningSteg
                ...
                visningTilskuddsperioder={VisningTilskuddsperioderVtao}
            />
        ),
        label: 'Godkjenning',
        id: 'godkjenning',
...
const mentorStegUtenBeregningAvTilskudd: StegInfo[] = [
    ...
    {
        komponent: (
            <GodkjenningSteg oppsummering={OppsummeringMentor} visningTilskuddsperioder={VisningTilskuddsperioder} />
        ),
        label: 'Godkjenning',
        id: 'godkjenning',
    },
