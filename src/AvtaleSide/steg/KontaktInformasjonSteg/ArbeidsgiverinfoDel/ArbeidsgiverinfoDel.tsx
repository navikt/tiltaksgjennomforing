        ...
        <SkjemaGruppe title="Kontaktperson for avtalen">
            <div className="arbeidsgiverkontaktpersonrad">
                <PakrevdInput
                    ...
                    settVerdi={_.partial(props.settAvtaleVerdi, 'arbeidsgiverFornavn')}
                />
                <PakrevdInput
                    className="arbeidsgiverkontaktpersonrad__etternavn"
                    label="Etternavn"
                    verdi={props.avtale.arbeidsgiverEtternavn}
                    settVerdi={_.partial(props.settAvtaleVerdi, 'arbeidsgiverEtternavn')}
                />
            </div>
            <div className="arbeidsgiverkontaktpersonrad">
                <TelefonnummerInput
                    ...
                    settVerdi={_.partial(props.settAvtaleVerdi, 'arbeidsgiverTlf')}
                />
            </div>
        </SkjemaGruppe>
    </>
