...
const RelasjonHjelpetekst: FunctionComponent<Props> = (props) => {
    ...
    return (
        <div className={cls.element('relasjon-hjelpetekst')}>
            ...
            Er det en nær relasjon mellom deg eller noen i virksomheten og deltakeren skal du huke av for dette i boksen
            under.
            <VerticalSpacer rem={0.5} />
            Du kan søke om oppstart av {litenForbokstav(avtaleTittel[props.tiltakstype])} selv om du har en nær relasjon
            til deltakeren, men du må oppgi at det er en nær relasjon og utdype tilknytningen. NAV vil deretter vurdere
            om det foreligger særlige grunner for likevel å innvilge tiltaket.
            <VerticalSpacer rem={0.5} />
