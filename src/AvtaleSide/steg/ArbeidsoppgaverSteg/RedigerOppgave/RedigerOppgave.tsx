...
class RedigerOppgave extends React.Component<Props, State> {
    state = {
        tittel: (this.props.defaultOppgave && this.props.defaultOppgave.tittel) || '',
        beskrivelse: (this.props.defaultOppgave && this.props.defaultOppgave.beskrivelse) || '',
        opplaering: (this.props.defaultOppgave && this.props.defaultOppgave.opplaering) || '',
    ...
    componentDidMount(): void {
        if (this.props.mellomLagretDataArbeidsoppgave) {
            if (
                ...
                this.setState({
                    tittel: this.props.mellomLagretDataArbeidsoppgave.oppgaveTittel,
                    beskrivelse: this.props.mellomLagretDataArbeidsoppgave.oppgaveBeskrivelse,
                    opplaering: this.props.mellomLagretDataArbeidsoppgave.oppgaveOpplaering,
                });
            }
        }
    }
    ...
    componentWillUnmount(): void {
        if (
            (this.state.tittel !== '' || this.state.beskrivelse !== '' || this.state.opplaering !== '') &&
            !this.state.erLagret
        ) {
        ...
        } else if (this.state.tittel === '' && this.state.beskrivelse === '' && this.state.opplaering === '') {
