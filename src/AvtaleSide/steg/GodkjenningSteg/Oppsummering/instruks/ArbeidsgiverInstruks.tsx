...
const ArbeidsgiverInstruks: FunctionComponent<Props> = props => (
    <>
        ...
        <Ekspanderbartpanel border={true} tittel="Les mer om kravene">
            <EkstbanderbartPanelRad svgIkon={<RettighetsHammerIkon />} headerTekst={{ tekst: 'Arbeidsmiljøloven' }}>
                En arbeidssøker som deltar på arbeidstrening blir i de fleste situasjoner regnet som en ordinær
                arbeidstaker etter arbeidsmiljøloven. Det betyr at arbeidsgivers og deltaker plikter til arbeidsmiljø og
                krav til kontrolltiltak også gjelder når arbeidssøkeren er på arbeidstrening. Det inkluderer blant annet
            ...
            >
                Den som er i arbeidstrening er omfattet av arbeidsgiverens yrkesskadeforsikring. Arbeidsgiveren er
                ansvarlig for skade som personen i arbeidstrening gjør, enten forsettlig eller uaktsomt. Du kan søke om
                inkluderingstilskudd for å dekke eventuelle kostnader i forbindelse med forsikringsansvaret.
            </EkstbanderbartPanelRad>
            <EkstbanderbartPanelRad
            ...
            >
                Du må drøfte inngåelse av avtale om arbeidstrening med representanter for de ansatte i din bedrift før
                en eventuell avtaleinngåelse. Tillitsvalgte og verneombud skal ivareta de ansattes interesser, og en
                tiltaksplass skal ikke erstatte en vanlig stilling i bedriften.
            </EkstbanderbartPanelRad>
            ...
            >
                Som arbeidsgiver må du sikre at all behandling av personopplysninger utføres etter krav til personvern,
                taushetsplikt og informasjonssikkerhet. Taushetsbelagte og sensitive personopplysninger skal ikke sendes
                mellom deg og NAV på usikrede og ukrypterte kommunikasjonskanaler, slik som usikret epost og faks.
                Senest innen 12 uker etter at tiltaksgjennomføringen er avsluttet, skal du eller databehandleren slette
                personopplysninger om den du har i arbeidstrening.
            </EkstbanderbartPanelRad>
        </Ekspanderbartpanel>
    </>
);
