            ...
            <Ekspanderbartpanel border={true} tittel="Les mer om kravene">
                ...
                {props.tiltakstype === 'SOMMERJOBB' && (
                    ...
                    >
                        ...
                        Personopplysninger om deg i avtalen lagres i henhold til arkivloven.
                        <Lenke
                            href={
                        ...
                        forteller mer om hvordan NAV behandler personopplysninger og hvilke rettigheter du har. 12 uker
                        etter avsluttet tiltak vil arbeidsgiver ikke lenger har tilgang til avtalen.
                    </EkspanderbartPanelRad>
                )}
            </Ekspanderbartpanel>
        </>
