...
const GiBeskjedHvisDuErBorteFraJobb: FunctionComponent<Props> = ({ tiltakstype }) => {
    ...
    return (
        ...
        >
            ...
            Du må melde fra til arbeidsgiver ved fravær. Ved egen eller barns sykdom gjelder ordinære regler for bruk av
            egenmelding også for deg som er på {tiltakstype === 'ARBEIDSTRENING' && 'arbeidstrening'}
