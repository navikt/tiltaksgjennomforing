...
test('Test at toFormattedProsent skriver default verdi 0% når det gis 35 som feltverdi', () => {
    expect(toFormattedProsent(toLimit(35, 0, 30))).toEqual('0 %');
});
...
test('Test at toFormattedProsent skriver default verdi 2% når det ingen feltverdi', () => {
    expect(toFormattedProsent(toLimit(undefined, 0, 30))).toEqual('0 %');
});
