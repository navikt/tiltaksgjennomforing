    ...
    return (
        <LesMerPanel className={cls.element('lonn-per-mnd')} åpneLabel="Hva menes med dette?" lukkLabel="Lukk">
            <div className={cls.element('lonn-per-mnd-seksjon')}>
                ...
                utført i normalarbeidstiden inkludert faste tillegg. Overtidsbetaling og andre variable tillegg skal
                ikke tas med. For deltidsstillinger skal lønn i den faktiske stillingsprosenten legges inn. For eksempel
                hvis deltaker er ansatt i en 50 % stilling, skal det legges inn månedslønn i 50 % stilling før skatt.
            </div>
