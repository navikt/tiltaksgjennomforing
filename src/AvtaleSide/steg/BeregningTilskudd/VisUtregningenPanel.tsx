        ...
        <Ekspanderbartpanel border={true} tittel="Vis hele utregningen" apen={true}>
            <Container fluid={true}>
                <Row className="visUtregningenPanel__rad">
                    <Column md="6" sm="12" xs="12" className="visUtregningenPanel__tittel">
                ...
                <Row className="visUtregningenPanel__rad">
                    <Column md="6" sm="9" xs="9" className="visUtregningenPanel__tittel">
                        <MediaQuery minWidth={700}>
                            <FeriepengerIkon className="visUtregningenPanel__ikon" />
                        </MediaQuery>
                        <div>Feriepenger</div>
                    </Column>
                    <Column md="3" sm="4" xs="4">
                        ({(props.avtale.feriepengesats * 100).toFixed(1)}%)
                    </Column>
                    <Column md="1" sm="2" xs="2">
                        +
                    </Column>
                    <Column md="2" sm="3" xs="3" className="visUtregningenPanel__column__siste">
                ...
                <Row className="visUtregningenPanel__rad visUtregningenPanel__rad__oppsummering">
                    <Column md="9" sm="12" xs="12" className="visUtregningenPanel__tittel">
                        <Undertittel> Månedlig lønnstilskudd fra Nav(inntil):</Undertittel>
                    </Column>

                    <Column md="3" sm="3" xs="3" className="visUtregningenPanel__column__siste">
                        <Undertittel>
