...
export interface RestService {
    ...
    skalBackupmenyBrukes: () => Promise<boolean>;
}
...
const skalBackupmenyBrukes = async (): Promise<boolean> => {
    const url = '/tiltaksgjennomforing/skal-backupmeny-brukes';
