...
import { m as ea } from './index-Vg9IHUb1.js';
...
function q(e, t = {}) {
    return (
        ca(t.expandedStates),
        { type: Ye, id: t.id, contents: e, break: !!t.shouldBreak, expandedStates: t.expandedStates }
    );
}
function pa(e) {
    ...
    switch (Ir(e)) {
        ...
        case xr: {
            ...
            for (let r of e) {
                ...
                typeof n == 'string' && typeof Pt(!1, t, -1) == 'string' ? (t[t.length - 1] += n) : t.push(n),
                    t.push(...u);
            }
...
function Cu(e, t) {
    ...
    if (
        ...
        for (let n of t.parameters.children)
            Ta.has(e.name) ? delete n.expression : (n.expression = n.expression.trim());
}
...
function za(e, t) {
    var r, n;
    let u = i();
    if (u && !e.prev && (n = (r = e.parent) == null ? void 0 : r.tagDefinition) != null && n.ignoreFirstLf)
...
function Ja(e) {
    return (
        ...
        (e.type === 'element' &&
            e.children.length > 0 &&
            (['body', 'script', 'style'].includes(e.name) || e.children.some((t) => Xa(t)))) ||
        (e.firstChild &&
...
function Me(e, t) {
    return (
        t.parser === 'vue' && e.type === 'element' && e.parent.type === 'root' && e.fullName.toLowerCase() !== 'html'
    );
}
function Hr(e, t) {
        ...
        if (Va(n))
            for (let u of n.children) {
                ...
                for (let o = 0; o < s.length; o++, i = a) {
                    ...
                    if (o % 2 === 0) {
                        (a = i.moveBy(l.length)),
                            l.length > 0 && n.insertChildBefore(u, { type: 'text', value: l, sourceSpan: new b(i, a) });
                        continue;
                    }
                    (a = i.moveBy(l.length + 4)),
                        n.insertChildBefore(u, {
                            ...
                            children:
                                l.length === 0
                                    ? []
                                    : [{ type: 'text', value: l, sourceSpan: new b(i.moveBy(2), a.moveBy(-2)) }],
                        });
                }
                n.removeChild(u);
            }
        ...
        if (!r)
            for (let u = 0; u < t.children.length; u++) {
                ...
                s
                    ...
                    : (t.removeChild(i),
                      u--,
                      (a || o) && (l && (l.hasTrailingSpaces = !0), c && (c.hasLeadingSpaces = !0)));
            }
            ...
            for (let u = 0; u < n.length; u++) {
                ...
                (i.isLeadingSpaceSensitive = (u === 0 || i.prev.isTrailingSpaceSensitive) && i.isLeadingSpaceSensitive),
                    (i.isTrailingSpaceSensitive =
                        (u === n.length - 1 || i.next.isLeadingSpaceSensitive) && i.isTrailingSpaceSensitive);
            }
        }
    });
}
...
function Hs(e, t) {
    ...
    return (
        e.lastChild && Qe(e.lastChild) ? (n += Wr(e, t).length) : nt(e) && (n -= rt(e.lastChild, t).length),
...
function ro(e) {
    ...
    let a = O(!1, u[1].trim(), n, ''),
        s = a.match(r);
    s
        ? ((i.alias = a.replace(r, '')), (i.iterator1 = s[1].trim()), s[2] && (i.iterator2 = s[2].trim()))
        : (i.alias = a);
...
function so(e, t, { parseWithTs: r }) {
    return io(e)
        ...
        : X(e, t, { parser: r ? '__vue_ts_event_binding' : '__vue_event_binding' }, Re);
}
...
function Co(e) {
    return async (t, r, n, u) => {
        ...
        if (i)
            return (
                (i = Or(i, (a) => (typeof a == 'string' ? O(!1, a, '"', '&quot;') : a))),
                [n.node.rawName, '="', q(i), '"']
            );
    };
}
...
function vo(e, t, r, n) {
    ...
    return /^\s*$/.test(i)
        ? ''
        : X(i, e, { parser: '__ng_directive', __isInHtmlAttribute: !1, trailingComma: 'none' }, Re);
}
var yo = vo,
    ...
    return H(e) && H(t)
        ...
        : (jt(e) && (Mr(t) || t.firstChild || t.isSelfClosing || (t.type === 'element' && t.attrs.length > 0))) ||
          ...
          : !t.isLeadingSpaceSensitive ||
              nr(t) ||
              (ve(t) && e.lastChild && Qe(e.lastChild) && e.lastChild.lastChild && Qe(e.lastChild.lastChild))
            ? A
            : t.hasLeadingSpaces
              ? L
              : I;
    ...
    Ko = class extends jo {
        ...
        hasElement(e, t) {
            return t.some((r) => r.name === vn.name) ||
                (e.indexOf('-') > -1 && (En(e) || bn(e) || t.some((r) => r.name === Fn.name)))
                ? !0
...
`,
        ...
        _getBlockName() {
            ...
            return (
                this._attemptCharCodeUntilFn((r) => (jr(r) ? !e : xn(r) ? ((e = !0), !1) : !0)),
        ...
        handleError(e) {
            if ((e instanceof Jr && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), e instanceof ar))
        ...
        _requireStrCaseInsensitive(e) {
            ...
            if (!this._attemptStrCaseInsensitive(e))
                throw this._createError(xe(this._cursor.peek()), this._cursor.getSpan(t));
        }
        ...
        _consumeInterpolation(e, t, r) {
            ...
            for (; this._cursor.peek() !== 0 && (r === null || !r()); ) {
                ...
                this._cursor.advance(),
                    o === 92 ? this._cursor.advance() : o === i ? (i = null) : !a && i === null && Dn(o) && (i = o);
            }
        ...
        _handleFullNameStackForTagOpen(e, t) {
            let r = St(e, t);
            (this._fullNameStack.length === 0 || this._fullNameStack[this._fullNameStack.length - 1] === r) &&
    ...
    El = class ei {
        ...
        build() {
            ...
            for (let t of this._containerStack)
                t instanceof Be && this.errors.push(R.create(t.name, t.sourceSpan, `Unclosed block "${t.name}"`));
        }
        _advance() {
            let t = this._peek;
        ...
        _parseExpansionCase() {
            ...
            if (this._peek.type !== 22)
                return (
                    this.errors.push(R.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null
                );
            let r = this._advance(),
            ...
            for (;;) {
                if (
                    ...
                    if (Ln(n, 22)) {
                        ...
                        return (
                            this.errors.push(R.create(null, t.sourceSpan, "Invalid ICU message. Missing '}'.")), null
                        );
                if (this._peek.type === 24)
                    if (Ln(n, 20)) n.pop();
                    else
                ...
                if (this._peek.type === 30)
                    return this.errors.push(R.create(null, t.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
            ...
            this._pushContainer(D, p instanceof oe && this.getTagDefinition(p.name).isClosedByChild(D.name)),
                a
                    ...
                    : t.type === 4 &&
                      ...
                      this.errors.push(R.create(i, o, `Opening tag "${i}" not terminated.`)));
        }
        _pushContainer(t, r) {
        ...
        _popContainer(t, r, n) {
            ...
            for (let i = this._containerStack.length - 1; i >= 0; i--) {
                ...
                if (
                    gt(a.name)
                        ? a.name === t
                        : (t == null || a.name.toLowerCase() === t.toLowerCase()) && a instanceof r
                )
                    return (
                        (a.endSourceSpan = n),
    ...
    let p = (f) => {
        ...
        m = (f) => {
            if (
                f.type === 'element' &&
                (i &&
                    (!f.namespace || f.namespace === f.tagDefinition.implicitNamespacePrefix || Xe(f)) &&
                    (f.name = d(f.name, (C) => xl.has(C))),
                a)
            )
                for (let C of f.attrs)
                    C.namespace ||
                        (C.name = d(C.name, (y) => or.has(f.name) && (or.get('*').has(y) || or.get(f.name).has(y))));
        },
        g = (f) => {
...
var ni = { name: 'html', normalizeTagName: !0, normalizeAttributeName: !0, allowHtmComponentClosingTags: !0 },
    ...
    $l = Ut({
        ...
        shouldParseAsRawText(e, t, r, n) {
            return (
                ...
                !r &&
                (e !== 'template' ||
                    n.some(({ name: u, value: i }) => u === 'lang' && i !== 'html' && i !== '' && i !== void 0))
            );
        },
    }),
    ...
    ui = (e, t, r, n) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
            for (let u of Xl(t))
                !Zl.call(e, u) && u !== r && zt(e, u, { get: () => t[u], enumerable: !(n = Yl(t, u)) || n.enumerable });
        return e;
    },
    it = (e, t, r) => (
        (r = e != null ? Jl(Ql(e)) : {}),
        ui(t || !e || !e.__esModule ? zt(r, 'default', { value: e, enumerable: !0 }) : r, e)
    ),
            ...
            switch (a) {
                ...
                case P:
                    if (n && i.expandedStates)
                        for (let s = i.expandedStates.length, o = s - 1; o >= 0; --o) u.push(i.expandedStates[o]);
    ...
    switch (ke(e)) {
        ...
        case pe: {
            ...
            for (let r of e) {
                if (!r) continue;
                let [n, ...u] = Array.isArray(r) ? r : [r];
                typeof n == 'string' && typeof k(!1, t, -1) == 'string' ? (t[t.length - 1] += n) : t.push(n),
                    t.push(...u);
            }
            return t.length === 0 ? '' : t.length === 1 ? t[0] : t;
        }
...
function Kc(e) {
    ...
    function n(i, a, s) {
        ...
        if (i.type === $)
            return ((l = s == null ? void 0 : s[a - 1]) == null ? void 0 : l.type) === B && s[a - 1].hard
                ? void 0
                : 'breakParent';
...
var rp = tp,
    ...
    np = (e, t, { descriptor: r }) => {
        ...
        return (
            t && n.push(`we now treat it as ${Un.default.blue(typeof t == 'string' ? r.key(t) : r.pair(t))}`),
            n.join('; ') + '.'
        );
    },
    Le = it(Jt(), 1),
                        ...
                        if (h !== !1)
                            if (h === !0)
                                this._hasDeprecationWarned(i) ||
                                    this._utils.logger.warn(this._deprecatedHandler(i, p, this._utils));
                            else
...
function Tp(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
    ...
    switch (e.type) {
        ...
        case 'choice':
            (a = yp),
                (i.choices = e.choices.map((o) =>
                    o != null && o.redirect ? { ...o, redirect: { to: { key: e.name, value: o.redirect } } } : o,
                ));
            break;
        case 'boolean':
            a = hp;
        ...
        case 'flag':
            (a = n),
                (i.flags = r.flatMap((o) =>
                    [o.alias, o.description && o.name, o.oppositeDescription && `no-${o.name}`].filter(Boolean),
                ));
            break;
        case 'path':
            a = ru;
...
function Mp(e, t) {
    ...
    function a(s, o) {
        ...
        let l = {},
            c = new Set(u(s));
        for (let p in s)
            !Object.prototype.hasOwnProperty.call(s, p) || i.has(p) || (c.has(p) ? (l[p] = a(s[p], s)) : (l[p] = s[p]));
        let D = r(s, l, o);
    ...
    Wp = class {
        ...
        match(...e) {
            ...
            for (let u of e) {
                ...
                let i = null;
                if ((typeof r == 'number' && ((i = r), (r = this.stack[t--]), (n = this.stack[t--])), u && !u(n, r, i)))
                    return !1;
...
function nn(e, t) {
    ...
    if (!n) return [];
    let s = ((r == null ? void 0 : r(e, t)) ?? [...Pi(e, { getVisitorKeys: er(u) })]).flatMap((o) =>
        n(o) ? [o] : nn(o, t),
    );
...
function e2(e, t) {
    ...
    for (let [h, d] of p.entries()) {
        ...
        if (
            (a
                ? (S = [d])
                : ((m.enclosingNode = F), (m.precedingNode = g), (m.followingNode = f), (S = [m, C, y, v, w])),
            t2(C, y, p, h))
        )
...
function uu(e, t) {
    ...
    for (let l of [i, a])
        l.comments && l.comments.length > 1 && l.comments.sort((c, D) => t.locStart(c) - t.locStart(D));
    e.length = 0;
}
function dr(e, t, r) {
...
async function $i(e, t, r = 0) {
    ...
    if (r > 0) {
        ...
        a.cursorNodeStart !== void 0 && (a.cursorNodeStart -= a.formatted.indexOf(o)),
    ...
    var u = n.reduce(function (s, o) {
        ...
        return l
            ? s.concat(
                  l.map(function (c) {
                      var D, p;
                      return (p = (D = c.match(/[\t ]/g)) === null || D === void 0 ? void 0 : D.length) !== null &&
                          p !== void 0
                          ? p
                          : 0;
                  }),
