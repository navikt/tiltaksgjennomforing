...
const { addons: j } = __STORYBOOK_MODULE_PREVIEW_API__,
    ...
    { ImplicitActionsDuringRendering: x } = __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
...
function y(t, e = {}) {
    let i = { ...P, ...e },
        n = function (...o) {
            ...
            if (e.implicit) {
                let _ =
                    (g = '__STORYBOOK_PREVIEW__' in R ? R.__STORYBOOK_PREVIEW__ : void 0) == null
                        ? void 0
            ...
            let r = j.getChannel(),
                ...
                b = {
                    ...
                    count: 0,
                    data: { name: t, args: I },
                    options: { ...i, maxDepth: p + (i.depth || 3), allowFunction: i.allowFunction || !1 },
                };
            r.emit(f, b);
        };
...
var A = (t, e) => typeof e[t] > 'u' && !(t in e),
    v = (t) => {
        ...
        return Object.entries(i)
            .filter(([a]) => !!r.test(a))
            .reduce((a, [p, s]) => (A(p, e) && (a[p] = y(p, { implicit: !0, id: n })), a), {});
    },
    k = (t) => {
        let {
            initialArgs: e,
        ...
        return (n != null && n.disable) || !i
            ...
            : Object.entries(i)
                  .filter(([o, r]) => !!r.action)
                  .reduce((o, [r, a]) => (A(r, e) && (o[r] = y(typeof a.action == 'string' ? a.action : r)), o), {});
    },
    L = [k, v],
